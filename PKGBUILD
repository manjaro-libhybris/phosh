...
depends=('gtk3' 'libhandy>=1.1.90' 'gnome-desktop' 'gnome-session'
         ...
         'phoc-hybris>=0.27.0' 'gnome-shell' 'callaudiod-hybris')
makedepends=('meson' 'git')
source=("git+https://github.com/droidian/phosh"
...
prepare() {
    ...
    git checkout 3fc22813b0c2caf73029e30ea79d35957a01c389
