...
source=("git+https://gitlab.gnome.org/World/Phosh/phosh.git#commit=${_commit}"
        ...
        "git+https://gitlab.gnome.org/guidog/libcall-ui.git"
         ...
         https://gitlab.gnome.org/World/Phosh/phosh/-/merge_requests/886.patch
	 "pam_phosh"
...
sha256sums=('SKIP'
            ...
            '420025fdeaaffd661938475ad38e676b89a506b1a7a4d0e54a358f0ae46d8e26'
